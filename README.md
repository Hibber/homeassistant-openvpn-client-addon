...
Just navigate to the Hass.io panel in your Home Assistant frontend and add the OpenVPN Client add-on repository: [https://github.com/Ailme/homeassistant-openvpn-client-addon](https://github.com/Hibber/homeassistant-openvpn-client-addon)
